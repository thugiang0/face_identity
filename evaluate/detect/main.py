...
GT_PATH = os.path.join(os.getcwd(), "fddb_test_1000/fddb_gt/")
DR_PATH = os.path.join(os.getcwd(), "fddb_test_1000/fddb_pred_retina/")
# if there are no images then no animation can be shown
IMG_PATH = "fddb_test_1000/fddb_images/"
...
output_files_path = "output_fddb_retina"
...
ground_truth_files_list = os.listdir('fddb_test_1000/fddb_gt/')
...
for txt_file in ground_truth_files_list:
    ...
    if not os.path.exists(temp_path):
        ...
        error(error_msg)
    lines_list = file_lines_to_list('fddb_test_1000/fddb_gt/' + txt_file)

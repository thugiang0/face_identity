from ...face_database.data_pipe import de_preprocess, get_train_loader, get_val_data
...
from .utils.prepare import get_time, gen_plot, hflip_batch, separate_bn_paras
...
#         self.writer.add_scalar('{}_far:False Acceptance Ratio'.format(db_name), far, self.step)
    ...
    def infer(self, conf, faces, target_embs, tta=False):
        ...
        min_dist = " ".join([str(x) for x in minimum.tolist()])


        # with open('id_unknown.txt', 'a') as file:
        #     file.write(min_dist + "\n")
